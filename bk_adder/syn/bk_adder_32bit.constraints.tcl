################################################################################
# Filename: bk_adder_32bit.constraints.tcl
# Author: ZHU Jingyang
...
set_output_delay -max 1 -clock VCLK [all_outputs]
set_input_delay -min 1 -clock VCLK \
  [remove_from_collection [all_inputs] [get_ports VCLK]]
set_output_delay -min 1 -clock VCLK [all_outputs]
################################################################################
