...
# rp_adder_32bit. The P&R flow is based on the EDI 13.1 official workshop and use the
...
# Load IO assignment file: rp_adder_32bit.ioc
...
# starting from the left offset 20.0 (roughly middle of the rp_adder_32bit module)
...
verifyGeometry -report reports/rp_adder_32bit.geometry.rpt
...
# Setup Timing Report
report_timing -machine_readable -max_paths 100 -max_slack 100.0 -min_slack -100.0 -late > rp_adder_32bit_setup.mtarpt

# Hold Timing Report
report_timing -machine_readable -max_paths 100 -max_slack 100.0 -min_slack -100.0 -early > rp_adder_32bit_hold.mtarpt
# ------------------------------------------------------------------------------
...
# *.gds: GDS file
streamOut results/rp_adder_32bit.gds -mapFile streamOut.map \
