...
analyze -format verilog {rp_adder_32bit.v}
elaborate rp_adder_32bit; # top module name

# store the unmapped results
write -hierarchy -format ddc -output results/rp_adder_32bit.unmapped.ddc
...
source rp_adder_32bit.constraints.tcl
...
check_design > reports/rp_adder_32bit.check_design.rpt; # dump to the file
...
# Write out design
write -format verilog -hierarchy -output results/rp_adder_32bit.mapped.v
write -format ddc -hierarchy -output results/rp_adder_32bit.mapped.ddc
write_sdf results/rp_adder_32bit.mapped.sdf
write_sdc -nosplit results/rp_adder_32bit.mapped.sdc

# Generate reports
report_qor > reports/rp_adder_32bit.mapped.qor.rpt
report_timing -transition_time -nets -attribute -nosplit \
  > reports/rp_adder_32bit.mapped.timing.rpt
report_area -nosplit > reports/rp_adder_32bit.mapped.area.rpt
report_power -nosplit > reports/rp_adder_32bit.mapped.power.rpt
